...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('frunner_testcaseassert', 'operator', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'TestCaseAssert.operator'
        db.alter_column('frunner_testcaseassert', 'operator', self.gf('django.db.models.fields.CharField')(max_length='16'))
