...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestCaseStep.exception'
        db.add_column('frunner_testcasestep', 'exception',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestCaseStep.exception'
        db.delete_column('frunner_testcasestep', 'exception')
