...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('frunner_testcase', 'login_type', self.gf('django.db.models.fields.CharField')(default='', max_length=16))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'TestCase.login_type'
        db.alter_column('frunner_testcase', 'login_type', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))
