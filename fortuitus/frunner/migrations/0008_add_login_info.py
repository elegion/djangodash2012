...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('frunner_testcase', 'login_type')

        # Deleting field 'TestCase.login_options'
        db.delete_column('frunner_testcase', 'login_options')
