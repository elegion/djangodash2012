...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestCaseAssert.lhs_value'
        db.add_column('frunner_testcaseassert', 'lhs_value',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)

        # Adding field 'TestCaseAssert.rhs_value'
        db.add_column('frunner_testcaseassert', 'rhs_value',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('frunner_testcaseassert', 'lhs_value')
    ...
    models = {
        ...
        'feditor.testproject': {
            'Meta': {'ordering': "('created',)", 'object_name': 'TestProject'},
        ...
        'frunner.testcase': {
            ...
            'login_type': ('django.db.models.fields.CharField', [], {'default': "'none'", 'max_length': '16'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        'frunner.testcaseassert': {
            ...
            'lhs_value': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '256'}),
            ...
            'rhs_value': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '256'}),
