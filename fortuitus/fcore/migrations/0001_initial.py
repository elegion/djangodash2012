...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('fcore_company', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, populate_from=None)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('fcore', ['Company'])

        # Adding model 'FortuitusProfile'
        db.create_table('fcore_fortuitusprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fcore.Company'])),
        ))
        db.send_create_signal('fcore', ['FortuitusProfile'])


    def backwards(self, orm):
        # Deleting model 'Company'
        db.delete_table('fcore_company')

        # Deleting model 'FortuitusProfile'
        db.delete_table('fcore_fortuitusprofile')
