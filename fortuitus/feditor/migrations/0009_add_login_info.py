...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestCase.login_type'
        db.add_column('feditor_testcase', 'login_type',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TestCase.login_options'
        db.add_column('feditor_testcase', 'login_options',
                      self.gf('jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestCase.login_type'
        db.delete_column('feditor_testcase', 'login_type')

        # Deleting field 'TestCase.login_options'
        db.delete_column('feditor_testcase', 'login_options')
